...
interface IAVNBridge {
  ...
  function checkLower(bytes calldata proof) external view returns (address token, address recipient, uint256 amount, uint256 confirmationsRequired, uint256 confirmationsProvided, bool validProof, bool lowerClaimed);
