 ...
 * Enables the triggering of periodic core token inflation, according to the rewards generated by T2.
 * Enables the "lifting" of any ETH, ERC20, or ERC777 tokens received to the T2 accounts specified in the lift.
 * Enables the "lowering" of ETH, ERC20, and ERC777 tokens from T2 back to the T1 accounts specified in the T2-provided proofs.
...
contract AVNBridge is IAVNBridge, IERC777Recipient, Initializable, UUPSUpgradeable, OwnableUpgradeable {
  ...
  /**
   * @dev Allows the owner to set themselves as the owner of the core token contract. Since the core token
   * must be owned by this contract for growth to function, this proides a means of reverting that ownership.
   */
  ...
  /**
   * @dev Allows the owner to enable or disable author functionality.
   */
  ...
  /**
   * @dev Allows the owner to enable or disable lifting.
   */
  ...
  /**
   * @dev Allows the owner to enable or disable lowering.
   */
   ...
   * according to the staking and rewards generated in a particular period.
   */
  ...
  /**
   * @dev Enables anyone to release the growth for a period, providing the time delay has passed.
   */
  ...
  /**
   * @dev Enables T2 to issue an instruction to add a new author, permanently associating their T1 and T2 accounts
   * and enabling them to take part in consensus. May also be used to reactivate an author, provided their details
  ...
  /**
   * @dev Enables T2 to issue an instruction to remove an author, immediately revoking their authority on T1.
   */
  ...
  /**
   * @dev Enables T2 to publish Merkle tree root hashes representing the latest sets of transactions to have occurred on T2.
   */
   ...
   * Tokens must first be approved for use by this contract. Fails if it will cause the total amount of these
   ...
   * Fails if it will cause the total amount of these tokens currently lifted to exceed
  ...
  /** @dev Allows lower proofs to be checked before being claimed. Returns details for any valid, unused lower,
  ...
  */
  ...
  /**
   * @dev Enables anyone to check the current status of an author transaction. Intended for use by T2 authors.
   */
