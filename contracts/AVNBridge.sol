...
contract AVNBridge is IAVNBridge, IERC777Recipient, Initializable, UUPSUpgradeable, OwnableUpgradeable {
   ...
   */
  function setCoreOwner() external onlyOwner {
   ...
   */
  function denyGrowth(uint32 period) external onlyOwner {
   ...
   * Can be set to zero.
   */
  function setGrowthDelay(uint256 delaySeconds) external onlyOwner {
  ...
  function _releaseGrowth(uint128 amount, uint32 period) private {
