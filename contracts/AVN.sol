...
contract AVN is IAVN, IERC777Recipient, Owned {
  ...
  function recoverERC777Tokens(address erc777Address)
    ...
    external
  {
    uint256 amount = IERC777(erc777Address).balanceOf(address(priorInstance));
    priorInstance.unlockERC777Tokens(erc777Address, address(this), amount);
  }
  ...
  function recoverERC20Tokens(address erc20Address)
    ...
    external
  {
    uint256 amount = IERC20(erc20Address).balanceOf(address(priorInstance));
